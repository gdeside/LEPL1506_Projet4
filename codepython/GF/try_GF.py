...
for name in names:
    ...
    plt.axvspan(3.50, 5.50, facecolor='steelblue', alpha=0.8, label='UR blind')
    plt.axvspan(5.50, 6.50, facecolor='deeppink', alpha=0.2, label='SP train')
    plt.axvspan(6.50, 8.50, facecolor='deeppink', alpha=0.5, label='SP no blind')
    plt.axvspan(8.50, 10.50, facecolor='deeppink', alpha=0.8, label='SP blind')
    plt.axvspan(10.50, 11.5, facecolor='khaki', alpha=0.2, label='UD train')
