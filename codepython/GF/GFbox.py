...
for name in names:
    ...
    plt.axvspan(6.50, 8.50, facecolor='deeppink', alpha=0.5, label='SP no bind')
    plt.axvspan(8.50, 10.50, facecolor='deeppink', alpha=0.8, label='SP bind')
    ...
    plt.axvspan(13.50, 15.5, facecolor='khaki', alpha=0.8, label='UD bind')
    plt.legend()
