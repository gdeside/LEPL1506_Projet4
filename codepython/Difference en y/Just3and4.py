...
for p, ax in zip(positions, tup):
    ...
    ax.text(index[0] + 0.35, 0.13, 'mean:%s' % transformpvalue(p2), fontsize=12)
    ax.text(index[0] + 0.375, 0.115, 'std:%s' % transformpvalue(pvalbis), fontsize=12)
...
plt.savefig("34_en_y_for_all.png")
file1.close()
